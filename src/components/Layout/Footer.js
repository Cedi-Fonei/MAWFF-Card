...
export default function Footer() {
    return (<div className="footer bg-info">
        ...
        <p>Icons (Light bulb, Candle Light, Candle bright) developed by Lorc for <a href="https://game-icons.net/">Game-icons.net</a></p>
        <p>Icons (Laser burst) developed by Skoll for <a href="https://game-icons.net/">Game-icons.net</a> </p>
    </div>)
}